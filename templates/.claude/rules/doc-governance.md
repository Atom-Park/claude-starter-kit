...
> 정본: `CLAUDE.md`(작업 규약·하지 말 것) — 근거·상세는 정본 참조.
...
- **공통 참조 문서**(CLAUDE.md·`docs/constitution.md`·`docs/conventions/*`·`.claude-starter-kit/*`·`.claude/rules/*`·`.claude/skills/*`·`.claude/settings.json`·`.githooks/*`·PR 템플릿·MEMBER-BOOTSTRAP·{{SUB_CLAUDE_MD}}) **수정 전 고지·재확인** — 수정은 `change-propagation` 스킬 절차(참조층↔집행층 동기·전수 grep〔숨김 경로 포함〕·지도표 갱신)로.
